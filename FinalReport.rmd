...
Looking at the graph is appears black are against CAPPUN compared to other. White favors CAPPUN more than black. 
...
Based on the table above, 34.62 black are in favor of CAPPUN, whereas Other is 83.33, and white is 68.66 in favor of CAPPUN. It appears there is a difference between the 3 categories, black, other, and white. 
...
When we analyzed the fisherXY test we saw there was a significant difference between Black, Other, and White. We also saw there was no drastic difference between Other and White.   
  
# Discussion and Conclusion

<!--Discussion and conclusion here.  If you found a relationship be sure to consider whether the relationship occurs because one of the variavbles causes the other, or whether they perhasps are related for some other reason.  Watch the chapter 6 videos from the GeorgeTown videos collection.!-->

At the Beginning of this report we had to do a lot of data manipulation to get the right graphs and fisher results and get a clear reading from out results. 
